    ...
    <div class="rating-content">
      <div class="overview">
        ...
        <div class="overview-right">
          ...
          <div class="score-warpper"><span class="title">商品评分</span>
      ...
      <div class="rating-warpper">
        <ul>
          <li v-for="rating in ratings" v-show="needShow(rating.rateType,rating.text)" class="rating-item">
            <div class="avatar">
              <img width="18px" height="18px" :src="rating.avatar">
            </div>
            <div class="content">
              ...
              <div class="recommend" v-show="rating.recommend && rating.recommend.length"><span
                class="icon-thumb_up"></span>
